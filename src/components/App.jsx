...
// TEMP KEEP:
    <div style={{backgroundColor: "#45558D", width: "100vw", height: "100vh"}} className="style1">
      <div className="inner centered" style={{paddingTop: "10%"}}>
        <h2 style={{textDecoration: "underline"}}>Luke Vandekieft</h2>
        <p style={{marginBottom: ".5em"}}>Full Stack Software Engineer</p>
        <p>React - Angular - AWS - Azure - Docker - Java</p>
      </div>
